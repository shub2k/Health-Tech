...
class Prediction:
    ...
    def show_prediction(self):
        ...
        model.load_state_dict(torch.load('staticfiles/Model weights/Covid_classifier_tf_efficientnet_b0_ns_fold0_validf10.9897097350755854.pth',map_location = 'cpu'))
        model.to(device)
        predi = ''
